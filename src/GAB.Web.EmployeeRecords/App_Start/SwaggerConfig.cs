...
namespace GAB.Web.EmployeeRecords
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "GAB.Web.EmployeeRecords");
        ...
        {
            return string.Format(@"{0}\bin\GAB.Web.EmployeeRecords.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
