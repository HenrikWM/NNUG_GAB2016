...
namespace GAB.Web.Reports.Api
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "GAB.Web.Reports.Api");
        ...
        {
            return string.Format(@"{0}\bin\GAB.Web.Reports.Api.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
